...
class ConstructorInjectedControllerTest {
	...
	void setUp() throws Exception {
		controller = new ConstructorInjectedController(new GreetingServiceImpl());  // 4. controller di lay sayGreeting() da duoc implement dong thoi tra ve greetingService
	}
